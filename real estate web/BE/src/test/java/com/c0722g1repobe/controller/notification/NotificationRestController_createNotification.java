...
public class NotificationRestController_createNotification {
     ...
     */
    @Test
    public void createNotification_postingDate_13() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setIdNotification(Long.valueOf(1));
        notificationDto.setTitle("Hop dau nam");
    ...
    @Test
    public void createNotification_postingDate_14() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setIdNotification(Long.valueOf(1));
        notificationDto.setTitle("Hop dau nam");
        notificationDto.setPostingDate(LocalDate.parse("  "));
     ...
     */
    @Test
    public void createNotification_postingDate_15() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setIdNotification(Long.valueOf(1));
        notificationDto.setTitle("Hop dau nam ");
        notificationDto.setPostingDate(LocalDate.parse("2023-02-01@#$$%"));
     ...
     */
    @Test
    public void createNotification_postingDate_16() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setIdNotification(Long.valueOf(1));
        notificationDto.setTitle("Hop dau nam");
     ...
     */
    @Test
    public void createNotification_postingDate_17() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setIdNotification(Long.valueOf(1));
        notificationDto.setTitle("Hop dau nam");
     ...
     */
    @Test
    public void createNotification_postingDate_99() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setIdNotification(Long.valueOf(1));
        notificationDto.setTitle("Hop dau nam ");
        notificationDto.setPostingDate(LocalDate.parse("2023.02.01"));
     ...
     */
    @Test
    public void createNotification_complete_18() throws Exception {
        NotificationDto notificationDto = new NotificationDto();
        notificationDto.setIdNotification(Long.valueOf(1));
        notificationDto.setTitle("Hop dau nam");
        notificationDto.setPostingDate(LocalDate.parse("2023-02-01"));
